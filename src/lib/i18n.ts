...
export const STRINGS: Dict = {
  ...
  "nav.forTeams": { en: "For Teams", id: "Untuk Tim" },
  "nav.typing": { en: "Typing", id: "Mengetik" },
  "nav.listening": { en: "Listening", id: "Menyimak" },
  "nav.workSkills": { en: "Work Skills", id: "Keterampilan Kerja" },
  "nav.standard": { en: "Standard", id: "Standar" },
  "nav.oneMinute": { en: "1 Minute", id: "1 Menit" },
  "nav.fiveMinute": { en: "5 Minute", id: "5 Menit" },
  "nav.dataEntry": { en: "Data Entry", id: "Entri Data" },
  "nav.punctuation": { en: "Punctuation", id: "Tanda Baca" },
  "nav.english": { en: "English", id: "Bahasa Inggris" },
  "nav.indonesian": { en: "Bahasa Indonesia", id: "Bahasa Indonesia" },
  "nav.noiseChallenge": { en: "Noise Challenge", id: "Tantangan Bising" },
  "nav.today": { en: "Today", id: "Hari ini" },
  "nav.season": { en: "Season", id: "Musim" },
  "nav.challenges": { en: "Friend Challenges", id: "Tantangan Teman" },
