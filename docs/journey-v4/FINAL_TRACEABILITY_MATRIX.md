...
| Production deployment and live verification | No deployment, DNS, remote push, merge, PR, analytics-provider, or AdSense mutation | Owner-controlled production configuration remains outstanding | EXTERNAL ACTION REQUIRED |
